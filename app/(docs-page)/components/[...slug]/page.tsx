...
import TableOfContents from '@/components/website/table-of-compoents';
    ...
    <>
      <div className='lg:px-0 lg:pt-0 pt-6 px-3 mt-0 flex w-full lg:gap-10 '>
        <div className='w-full relative xl:pl-0 lg:pl-4 pl-0'>
          ...
          <Footer />
          <GapPattern className='2xl:h-full lg:h-full h-full lg:block hidden lg:w-10 w-5 border-x border-y-0 absolute -right-8 top-0' />
        </div>
