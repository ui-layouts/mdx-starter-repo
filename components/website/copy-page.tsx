...
export default function CopyPage() {
  ...
  const fetchMdx = async (): Promise<string> => {
    ...
    if (!resp.ok) {
      throw new Error('Could not fetch MDX');
    }
  ...
  const openV0 = () => {
    const prompt = `I’m looking at this ui-layouts documentation: ${docsUrl}.\nHelp me understand how to use it. Be ready to explain concepts, give examples, or help debug based on it.`;
    const encoded = encodeURIComponent(prompt);
    const url = `https://v0.app/?q=${encoded}`;
    ...
    <div className='bg-secondary group/buttons relative flex rounded-lg p-1 gap-1'>
      ...
      <DropdownMenu>
        ...
        >
          ...
          <DropdownMenuItem onClick={openV0}>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='currentColor'
              viewBox='0 0 147 70'
            ...
            >
              <path d='M56 50.203V14h14v46.156C70 65.593 65.593 70 60.156 70c-2.596 0-5.158-1-7-2.843L0 14h19.797L56 50.203ZM147 56h-14V23.953L100.953 56H133v14H96.687C85.814 70 77 61.186 77 50.312V14h14v32.156L123.156 14H91V0h36.312C138.186 0 147 8.814 147 19.688V56Z'></path>
            </svg>{' '}
            Open in V0
          </DropdownMenuItem>
